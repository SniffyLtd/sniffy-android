...
public final class BackOfficeConstants {
	...
	public static final String BO_URL = "http://sniffy-bo.herokuapp.com";
	
	public static final String SYNCHRONIZATION_SERVICE = "/mobile/sync";

	public static final String INIT_SYNC_METHOD = "/init";
	
	public static final String PRODUCT_SERVICE = "/mobile/product";
	
	public static final String FIND_BY_BARCODE_METHOD = "/find/%s";
